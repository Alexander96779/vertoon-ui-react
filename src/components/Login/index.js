        ...
        <ul className="navbar-nav align-items-lg-center ml-lg-auto">
          ...
          <li className="nav-item d-none d-lg-block ml-lg-4">
            <a href="https://www.creative-tim.com/product/argon-dashboard-pro?ref=ad_upgrade_pro" target="_blank" className="btn btn-neutral btn-icon">
              ...
              <span className="nav-link-inner--text">Request a DEMO</span>
            </a>
          </li>
        </ul>
      </div>
        ...
        <div className="header-body text-center mb-7">
          <div className="row justify-content-center">
            <div className="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p className="text-lead text-white">Login to create and monitor campaigns, engage your exhibitors and explorers, and so much more!</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="col-lg-6 col-md-6">
          <div className="card bg-secondary border-0 mb-0">
            <div className="card-header bg-transparent pb-5">
              ...
              <div className="btn-wrapper text-center">
                <a href="#" class="btn btn-neutral btn-icon google_btn">
                  <span className="btn-inner--icon"><img src={google} alt="google-pic" /></span>
                  <span className="btn-inner--text">Google</span>
                </a>
                <a href="#" className="btn btn-neutral btn-icon facebook_btn">
                  <span className="btn-inner--icon"><i class="fab fa-facebook brand-icon"></i></span>
                  <span className="btn-inner--text">Facebook</span>
                </a>
                <a href="#" className="btn btn-neutral btn-icon twitter_btn">
                  <span className="btn-inner--icon">
                    <i className="fab fa-twitter brand-icon"></i>
                  </span>
            ...
            <div className="card-body px-lg-5 py-lg-5">
              ...
              <form role="form">
                <div className="form-group mb-3">
                  <div className="input-group input-group-merge input-group-alternative">
                    <div className="input-group-prepend">
                      <span className="input-group-text"><i class="ni ni-email-83"></i></span>
                    </div>
                ...
                <div className="form-group">
                  <div className="input-group input-group-merge input-group-alternative">
                    <div className="input-group-prepend">
                      <span className="input-group-text"><i class="ni ni-lock-circle-open"></i></span>
                    </div>
          ...
          <div className="row mt-3">
            ...
            <div className="col-6 text-right">
              <a href="/signup" className="text-light"><small>Create new account</small></a>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="row align-items-center justify-content-xl-between">
        <div className="col-xl-6">
          <div className="copyright text-center text-xl-left text-muted">
            &copy; 2020 <span class="font-weight-bold ml-1" target="_blank">Vertoon</span>
          </div>
        </div>
        <div className="col-xl-6">
          <ul className="nav nav-footer justify-content-center justify-content-xl-end">
            ...
            <li className="nav-item">
              <a href="#" className="nav-link" target="_blank">Terms and Conditions</a>
            </li>
            <li className="nav-item">
